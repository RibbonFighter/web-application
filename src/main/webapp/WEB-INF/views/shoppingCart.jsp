...
<body>
	...
	<div class="page_title">My Cart</div>
			...
			<c:forEach items="${cartForm.cartLineInfos }" var="cartLineInfo" varStatus="varStatus">
				<div class="product-preview-container" >
					<ul>
						...
						<form:hidden path="cartLineInfos[${varStatus.index }].productInfo.code" /></li>
						...
						<li>
							Quantity: <form:input path="cartLineInfos[${varStatus.index }].quantity" />
						</li>
